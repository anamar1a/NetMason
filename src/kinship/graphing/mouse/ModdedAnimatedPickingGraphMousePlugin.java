 ...
 * @author Tom Nelson
 */
public class ModdedAnimatedPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin implements MouseListener, MouseMotionListener {
	 ...
	 * 
	 */
	public ModdedAnimatedPickingGraphMousePlugin() {
	 ...
	 */
	public ModdedAnimatedPickingGraphMousePlugin(int selectionModifiers) {
